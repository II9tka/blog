...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', backend.account.models.account_model.AccountManager()),
            ],
        ),
        migrations.CreateModel(
            name='AccountImage',
            fields=[
                ...
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='filer.image', verbose_name='avatar')),
            ],
            options={
